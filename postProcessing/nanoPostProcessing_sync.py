...
if isTrilep or isDilep or isSinglelep:
    ...
    new_variables.extend( ['l1_pt/F', 'l1_mvaTOP/F', 'l1_mvaTOPWP/I', 'l1_mvaTOPv2/F', 'l1_mvaTOPv2WP/I', 'l1_ptCone/F', 'l1_eta/F', 'l1_phi/F', 'l1_pdgId/I', 'l1_index/I', 'l1_jetPtRelv2/F', 'l1_jetPtRatio/F', 'l1_miniRelIso/F', 'l1_relIso03/F', 'l1_dxy/F', 'l1_dz/F', 'l1_mIsoWP/I', 'l1_eleIndex/I', 'l1_muIndex/I', 'l1_isFO/O', 'l1_isTight/O','l1_jetBTag/F','l1_sip3d/F','l1_lostHits/I'] )
    new_variables.extend( ['mlmZ_mass/F'])
    if isMC:
        new_variables.extend(['reweightLeptonSF/F', 'reweightLeptonSFUp/F', 'reweightLeptonSFDown/F'])
if isTrilep or isDilep:
    new_variables.extend( ['l2_pt/F', 'l2_mvaTOP/F', 'l2_mvaTOPWP/I', 'l2_mvaTOPv2/F', 'l2_mvaTOPv2WP/I', 'l2_ptCone/F', 'l2_eta/F', 'l2_phi/F', 'l2_pdgId/I', 'l2_index/I', 'l2_jetPtRelv2/F', 'l2_jetPtRatio/F', 'l2_miniRelIso/F', 'l2_relIso03/F', 'l2_dxy/F', 'l2_dz/F', 'l2_mIsoWP/I', 'l2_eleIndex/I', 'l2_muIndex/I', 'l2_isFO/O', 'l2_isTight/O','l2_jetBTag/F','l2_sip3d/F','l2_lostHits/I'] )
...
if isTrilep:
    new_variables.extend( ['l3_pt/F', 'l3_mvaTOP/F', 'l3_mvaTOPWP/I', 'l3_mvaTOPv2/F', 'l3_mvaTOPv2WP/I', 'l3_ptCone/F', 'l3_eta/F', 'l3_phi/F', 'l3_pdgId/I', 'l3_index/I', 'l3_jetPtRelv2/F', 'l3_jetPtRatio/F', 'l3_miniRelIso/F', 'l3_relIso03/F', 'l3_dxy/F', 'l3_dz/F', 'l3_mIsoWP/I', 'l3_eleIndex/I', 'l3_muIndex/I', 'l3_isFO/O', 'l3_isTight/O','l3_jetBTag/F','l3_sip3d/F','l3_lostHits/I'] )
    new_variables.extend( ['l4_pt/F', 'l4_mvaTOP/F', 'l4_mvaTOPWP/I', 'l4_mvaTOPv2/F', 'l4_mvaTOPv2WP/I', 'l4_ptCone/F', 'l4_eta/F', 'l4_phi/F', 'l4_pdgId/I', 'l4_index/I', 'l4_jetPtRelv2/F', 'l4_jetPtRatio/F', 'l4_miniRelIso/F', 'l4_relIso03/F', 'l4_dxy/F', 'l4_dz/F', 'l4_mIsoWP/I', 'l4_eleIndex/I', 'l4_muIndex/I', 'l4_isFO/O', 'l4_isTight/O','l4_jetBTag/F','l4_sip3d/F','l4_lostHits/I'] )
...
def filler( event ):
    ...
    for iJet, jet in enumerate(store_jets):
        ...
        jet['isBJet'] = isBJet(jet, tagger=b_tagger, WP=options.btag_WP, year=options.era) 
    ...
    if isSinglelep or isTrilep or isDilep:
        ...
        if len(leptons)>=1:
            ...
            event.l1_jetBTag    = leptons[0]['jetBTag']
            event.l1_sip3d      = leptons[0]['sip3d']
            event.l1_lostHits   = leptons[0]['lostHits']
    ...
    if isTrilep or isDilep:
        if len(leptons)>=2:
            ...
            event.l2_jetBTag    = leptons[1]['jetBTag']
            event.l2_sip3d      = leptons[1]['sip3d']
            event.l2_lostHits   = leptons[1]['lostHits']
        ...
        if len(leptons)>=3:
            ...
            event.l3_jetBTag    = leptons[2]['jetBTag']
            event.l3_sip3d      = leptons[2]['sip3d']
            event.l3_lostHits   = leptons[2]['lostHits']
        ...
        if len(leptons)>=4:
            ...
            event.l4_jetBTag    = leptons[3]['jetBTag']
            event.l4_sip3d      = leptons[3]['sip3d']
            event.l4_lostHits   = leptons[3]['lostHits']
