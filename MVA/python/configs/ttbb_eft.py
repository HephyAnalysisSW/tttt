...
import tttt.samples.nano_mc_private_UL20_Autumn18_postProcessed_dilep as samples
...
sample_EFT = Sample.fromDirectory( "EFT", ["/scratch-cbe/users/maryam.shooshtari/tttt/nanoTuples/tttt_v8/UL2018/dilep/TTbb_MS_EFT/"] ) 
# ttbar gen classification: https://github.com/cms-top/cmssw/blob/topNanoV6_from-CMSSW_10_2_18/TopQuarkAnalysis/TopTools/plugins/GenTtbarCategorizer.cc
...
TTLep_bb_EFT    = copy.deepcopy( sample_EFT )
TTLep_bb_EFT.name = "TTLep_bb_EFT"
TTLep_bb_EFT.texName = "t#bar{t}b#bar{t} MG EFT"
TTLep_bb_EFT.color   = ROOT.kRed - 3

training_samples = [ TTLep_bb, TTLep_bb_EFT]
classes          = [ "Pow", "MG"]
...
selection = 'trg-dilepVL-minDLmass20-offZ1-njet3p-ht500'
