...
#From Tools
from tttt.Tools.helpers          import deltaPhi, deltaR2, deltaR, getCollection, getObjDict, m3
...
import tttt.samples.nano_mc_private_UL20_Summer16_preVFP_postProcessed_dilep as samples
...
# training_samples = [samples.TTTT, sample_TTLep]

# classes          = [ "2l_4t", "2l_tt"]#,"2l_ttcc","2l_ttlight"]
classes          = [ "2l_4t", "2l_tt","2l_ttcc","2l_ttlight"]
