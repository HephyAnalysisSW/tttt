...
TTbb_EFT	= Sample.fromDirectory(name="TTbb_EFT", treeName="Events", isData=False, color=color.TTbb, texName="t#bar{t}b#bar{b}", directory=['/scratch-cbe/users/cristina.giordano/tttt/nanoTuples/tttt_v9/UL2016/dilep/TTbb_MS_EFT'])
TTbb_EFT.reweight_pkl = '/groups/hephy/cms/robert.schoefbeck/gridpacks/4top/TTbb_MS_reweight_card.pkl'
TTTT_EFT    = Sample.fromDirectory(name="TTTT_EFT", treeName="Events", isData=False, color=color.TTTT, texName="t#bar{t}t#bar{t}", directory=['/scratch-cbe/users/cristina.giordano/tttt/nanoTuples/tttt_v9/UL2016/dilep/TTTT_MS_EFT'])
