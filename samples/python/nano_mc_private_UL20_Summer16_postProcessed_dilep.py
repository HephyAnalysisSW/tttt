...
T     = Sample.fromDirectory(name="T",     treeName="Events", isData=False, color=color.T,   texName="t" , directory=make_dirs( ['T_tch_pow', 'Tbar_tch_pow'] ))
TW    = Sample.fromDirectory(name="TW",    treeName="Events", isData=False, color=color.tW,  texName="tW", directory=make_dirs( ['T_tWch', 'TBar_tWch'] ))
