...
for e in "2016_preVFP" "2016" "2017" "2018";do
  for c in ${cuts[@]};do
    for s in ${sys[@]};do
      echo submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --sys $s"
      submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --sys $s"
    done
    for pdf in "${pdfs[@]}";do
      echo submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --sys $pdf"
      submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --sys $pdf"
    done
    echo submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --wc cQQ1 cQQ8 ctt cQt1 cQt8 ctHRe ctHIm"
    submit "python systematics.py --plot_directory 4t-v20-syst --selection $c --era $e --wc cQQ1 cQQ8 ctt cQt1 cQt8 ctHRe ctHIm" 
  done
done
