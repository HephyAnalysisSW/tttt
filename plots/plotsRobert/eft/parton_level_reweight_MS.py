...
# FWLite from CMSSW
TTTT_MS         = FWLiteSample.fromFiles("TTTT_MS",      ["root://eos.grid.vbc.ac.at//eos/vbc/group/cms/robert.schoefbeck/tttt/simulation/TTTT_MS.root"]) 
TTTT_MS_cQQ1_1p = FWLiteSample.fromFiles("TTTT_MS_cQQ1_1p", ["root://eos.grid.vbc.ac.at//eos/vbc/group/cms/robert.schoefbeck/tttt/simulation/TTTT_MS_cQQ1_1p.root"]) 
...
r_TTTT_MS_cQQ1_1p = TTTT_MS_cQQ1_1p.fwliteReader( products = products )
r_TTTT_MS_cQQ1_1p.start()
...
plots = [ 
    ...
    {'sample': "TTTT_MS",      'weight':cQQ1_1p_weight, "color": ROOT.kRed,    "name": "sim@SM to cQQ1=1"},
    {'sample': "TTTT_MS_cQQ1_1p", 'weight':sm_weight, "color": ROOT.kBlue,        "name": "sim@cQQ1=1 to SM"},
    {'sample': "TTTT_MS_cQQ1_1p", 'weight':cQQ1_1p_weight, "color": ROOT.kGreen,  "name": "sim@cQQ1=1 to cQQ1=1"},
]
...
for reader in [ r_TTTT_MS, r_TTTT_MS_cQQ1_1p]:
    i_event = 0
...
for var in variables:
    plotting.draw( 
            ...
            plot_directory = os.path.join( plot_directory, 'eft_MS'),
            yRange = 'auto',
            legend = "auto",
