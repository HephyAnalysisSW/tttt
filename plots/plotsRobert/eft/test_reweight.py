...
GEN = Events(["root://eos.grid.vbc.ac.at//eos/vbc/group/cms/robert.schoefbeck/tttt/simulation/TTTT_MS.root"]) #change to your location
...
for n_event in range(5):
    ...
    for name, product in products.iteritems():
        GEN.getByLabel(products[name]['label'], handles[name])
