...
argParser.add_argument('--plot_directory', action='store', default='TMB_4t3l')
argParser.add_argument('--selection',      action='store', default='trilepL-offZ1-njet4p-btag2p-ht200')
...
#mc = [ TTLep_bb, TTLep_cc, TTLep_other, ST, TTW, TTH, TTZ, DY, DiBoson, TTTT] 
...
jetVars     = ['pt/F', 'eta/F', 'phi/F', 'btagDeepFlavB/F', 'btagDeepFlavCvB/F', 'btagDeepFlavQG/F', 'chEmEF/F', 'chHEF/F', 'neEmEF/F', 'neHEF/F' ]
