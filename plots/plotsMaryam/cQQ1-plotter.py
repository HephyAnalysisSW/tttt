...
TTLep_bb.color   = ROOT.kBlack#ROOT.kRed + 2
TTLep_bb.setSelectionString( "genTtbarId%100>=50" )
TTLep_bb.style = styles.errorStyle(ROOT.kBlack)

TTbb01j_SMonly.style = styles.errorStyle(ROOT.kCyan+3)
TTbb01j_cQQ1_quad.style = styles.errorStyle(ROOT.kBlue)
TTbb01j_cQQ1_lin.style = styles.errorStyle(ROOT.kCyan)
...
mc = [TTLep_bb ,TTbb01j_SMonly, TTbb01j_cQQ1_quad , TTbb01j_cQQ1_lin]
...
# This weight goes to the plot. DO NOT apply it again to the samples
    ...
    if not args.noData:
        ...
        #stack = Stack(mc)
        stack = Stack ([TTLep_bb] ,[TTbb01j_SMonly], [TTbb01j_cQQ1_quad] , [TTbb01j_cQQ1_lin])
