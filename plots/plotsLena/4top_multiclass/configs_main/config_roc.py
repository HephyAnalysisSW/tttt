...
plot_directory = "fixed_3p_noData"
dirname = os.path.join(plot_path, plot_directory,"RunII/all")
results_dir = os.path.join(plot_path, plot_directory,"RunII/roc/test/")
njetsel = [
"dilepL-offZ1-njet4p-btag3p-ht500/combined/"
]
...
data_compare_2p = [
("btag2p 2l MVA ",                 "MVA_TTTT_btag2p_b-20000_e-500_hs1-96_hs2-53.root",ROOT.kRed),
("btag2p 2l MVA + LSTM",           "MVA_TTTT_btag2p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25.root",ROOT.kBlue),
("btag2p 2l MVA + LSTM, doubleB",  "MVA_TTTT_btag2p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen),
]
data_compare_3p = [
("btag3p 2l MVA ",                 "MVA_TTTT_btag3p_b-20000_e-500_hs1-96_hs2-53.root",ROOT.kRed),
("btag3p 2l MVA + LSTM",           "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25.root",ROOT.kBlue),
("btag3p 2l MVA + LSTM, doubleB",  "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen),
]
data_compare_3p_old = [
("old tr. 2l MVA ",                 "MVA_TTTT_model_b-20000_e-500_hs1-70_hs2-40.root",ROOT.kRed),
("old tr. 2l MVA + LSTM",           "MVA_TTTT_model_b-20000_e-750_hs1-70_hs2-40_lstm-4_hs-lstm-25.root",ROOT.kBlue),
("old tr. 2l MVA + LSTM, doubleB",  "MVA_TTTT_model_b-20000_e-750_hs1-70_hs2-40_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen),
]
...
("btag2p  2l MVA + LSTM",           "MVA_TTTT_btag2p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25.root",ROOT.kBlue),
("btag2p  2l MVA + LSTM, doubleB",  "MVA_TTTT_btag2p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen),
("btag3p  2l MVA ",                 "MVA_TTTT_btag3p_b-20000_e-500_hs1-96_hs2-53.root",ROOT.kRed-2),
("btag3p  2l MVA + LSTM",           "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25.root",ROOT.kBlue-2),
("btag3p  2l MVA + LSTM, doubleB",  "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen-2),
]
...
("old tr. 2l MVA + LSTM",           "MVA_TTTT_model_b-20000_e-750_hs1-70_hs2-40_lstm-4_hs-lstm-25.root",ROOT.kBlue),
("old tr. 2l MVA + LSTM, doubleB",  "MVA_TTTT_model_b-20000_e-750_hs1-70_hs2-40_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen),
("new tr. 2l MVA ",                 "MVA_TTTT_btag3p_b-20000_e-500_hs1-96_hs2-53.root",ROOT.kRed+2),
("new tr. 2l MVA + LSTM",           "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25.root",ROOT.kBlue+3),
("new tr. 2l MVA + LSTM, doubleB",  "MVA_TTTT_btag3p_b-20000_e-750_hs1-96_hs2-53_lstm-4_hs-lstm-25_DoubleB.root",ROOT.kGreen+2),
]
...
(data_compare_3p_old, "Comparison of MVAs (w/o LSTM, w/o DoubleB)", "roc_comp_3p_old"),
(data_compare, "Comparison of MVAs (w/o LSTM, w/o DoubleB)", "roc_comp"),
(data_compare_oldnew, "Comparison of MVAs (w/o LSTM, w/o DoubleB)", "roc_comp_oldnew"),
]
